...
// fetch categorues from database
...
<?php  elseif (isset($_SESSION['delete-category-success'])) : // shows if edit category was successful?>
        <div class="alert__message success container">
                <p>
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li>
                    <a href="manage-all-post.php" class="active"><i class="uil uil-postcard"></i>
            ...
            <?php if (mysqli_num_rows($allposts) > 0) : ?> 
            <table>
                <thead>
       ...
       <tbody>
                   ...
                   <?php while ($category = mysqli_fetch_assoc($allposts)) : ?> 

                    <tr> 
                        <td> <?= $category['title'] ?></td>
                        <td><a href="<?= ROOT_URL?>admin/edit-post.php? id=<?= $category['id'] ?>" class="btn sm">Edit</a></td>
                        <td><a href="<?= ROOT_URL?>admin/delete-post.php? id=<?= $category['id'] ?> "class="btn sm danger">delete</a></td>
                    </tr>
                        <?php endwhile ?>
                 </tbody>
            </table>
