...
if(isset($_POST['submit'])) {
    ...
    if (!$firstname) { 
        ...
        $_SESSION['add-user'] = "Please enter youra valid email";
        ...
        $_SESSION['add-user'] = "Please add avatar";
            ...
            if($createpassword !== $confirmpassword) {
                ...
                if(mysqli_num_rows($user_check_result) > 0) {
                    ...
                    //work on avatar
                    // rename avatar
                    $time = time(); // make each imaga name uniqui using current timestamp
                    $avatar_name = $time . $avatar['name'];
                    $avatar_tmp_name = $avatar['tmp_name'];
                    $avatar_destination_path = '../images/' . $avatar_name;

                    // make sure file is an image
                    $allowed_files = ['PNG','png','JPEG','jpeg' ,'JPG' ,'jpg','webp'];
                    ...
                    if(in_array($extention, $allowed_files)) {
                        ...
                        if($avatar['size'] < 1000000 ){
                            ...
                            $_SESSION['add-user'] = "File size too big, Should be less than 25mb";
                        }
                    }else {
